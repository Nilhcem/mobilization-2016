...
public class DbMapper {
    ...
    public Session fromAppSession(@Nullable com.nilhcem.mobilization.data.app.model.Session from) {
        if (from == null) {
            return null;
        }
    ...
    public Speaker fromAppSpeaker(@Nullable com.nilhcem.mobilization.data.app.model.Speaker from) {
        if (from == null) {
            return null;
        }
