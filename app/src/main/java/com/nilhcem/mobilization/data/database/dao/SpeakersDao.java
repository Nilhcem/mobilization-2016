...
import com.nilhcem.mobilization.data.database.model.Speaker;
...
public class SpeakersDao {
    ...
    public Observable<Map<Integer, com.nilhcem.mobilization.data.app.model.Speaker>> getSpeakersMap() {
        return getSpeakers().map(appMapper::speakersToMap);
    }

    public Observable<List<com.nilhcem.mobilization.data.app.model.Speaker>> getSpeakers() {
    ...
    public void saveSpeakers(List<com.nilhcem.mobilization.data.app.model.Speaker> toSave) {
        Preconditions.checkNotOnMainThread();

        BriteDatabase.Transaction transaction = database.newTransaction();
        try {
            database.delete(Speaker.TABLE, null);
            for (com.nilhcem.mobilization.data.app.model.Speaker speaker : toSave) {
